...
Drawing Function by creating blank image using opencv
...
img = np.zeros((512,512,3),np.uint8)*255 #for creating black screen image

#img = np.ones((512,512,3),np.uint8)*255 #for creating white screen image
